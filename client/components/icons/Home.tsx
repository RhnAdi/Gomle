...
const HomeIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="eva eva-home" fill="inherit" {...props}>
    <g data-name="Layer 2">
      <g data-name="home">
        <path d="M10 14h4v7h-4z" fill="currentColor" />
        <path
