...
export default function UserFollow() {
  return (
    <div className="flex gap-x-3 items-center">
      <div className="bg-slate-100 rounded-full p-1.5 text-sky-500 w-min border border-sky-500">
        <UserIcon />
      </div>
      <div className="flex-grow">
        <p className="text-slate-700 dark:text-white text-sm font-semibold">
          Angelina Catarina
        </p>
